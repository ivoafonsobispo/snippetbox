...
import (
	...
	"github.com/ivoafonsobispo/snippetbox/internal/models"
	"github.com/ivoafonsobispo/snippetbox/internal/validator"
...
func (app *Application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Password), "password", "This field cannot be blanck")
...
func (app *Application) accountPasswordUpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		if errors.Is(err, models.ErrInvalidCredentials) {
			form.AddFieldErrors("currentPassword", "Current password is incorrect")
